...
### Changed
- Restricted source distributions to the public package source, metadata, and runnable examples.
- Added a deterministic, allowlisted public-source export with private-marker, archive-safety, and provenance-manifest checks in the release gate.

## [0.1.1] - 2026-07-24

### Fixed
- Replaced private repository, documentation, issue, and changelog project links with the public ToolGauntlet guide and HiLo Labs support path.
- Updated the public-release monitor to recognize the released package page and no-key quickstart.
